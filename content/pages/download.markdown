...
- قبلا یک صفحه بود که کل کتاب یک جا توش بود. در مهاجرت به پلیکان این حذف شده. در آینده باید درستش کنم
...
از کیفیت فایل‌های دانلودی راضی نیستین؟* کیفیت بهترش رو درست کنین و به آدرس jadijadi+jff@gmail.com بفرستید تا جایگزین کنم *نقدها و پیشنهادها رو به jadijadi+jff@gmail.com بفرستین تا اگر تونستم اصلاح کنم

و البته اگر می خواین کتاب کاغذی رو بخرین، از [صفحه حمایت ها](/pages/support.html) می‌تونین سفارش بدین.